...
To build the final jar and optimize the webui application for production, run:
...
Then navigate to [http://localhost:11401](http://localhost:11401) in your browser.
